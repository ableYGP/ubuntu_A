...
create table st_info(ST_ID int, NAME varchar(20), DEPI varchar(25));
show tables;
...
insert into st_info values(202201, '80', '70');
insert into st_info values(202202, '90', '75');
insert into st_info values(202203, '95', '85');
